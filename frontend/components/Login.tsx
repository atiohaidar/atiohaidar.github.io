...
const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
    ...
    return (
        <div className="max-w-md mx-auto bg-light-navy p-8 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    ...
                    className={`w-full py-3 px-4 ${COLORS.BG_ACCENT} text-deep-navy font-semibold rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50`}
                >
                    {loginMutation.isPending ? 'Logging in...' : 'Login'}
                </button>
            </form>

            <div className="mt-6 p-4 bg-deep-navy/50 rounded-lg">
                <p className="text-xs text-soft-gray mb-2">Test Credentials:</p>
