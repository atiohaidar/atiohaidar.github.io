...
import { RoomInfoCard, BookingTimeline } from './room';
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className={cx(palette.panel.bg, palette.panel.border, 'rounded-lg p-8')}>
          {/* Informasi Ruangan - Refactored to use RoomInfoCard */}
          <RoomInfoCard room={room} className="mb-8 shadow-none p-0 bg-transparent dark:bg-transparent" />
          ...
          <div className={cx('mt-8 pt-6', 'border-t', palette.panel.divider)}>
            ...
            {bookingLoading ? (
              ...
              <BookingTimeline
                ...
                getDisplayDates={getDisplayDates}
              />
            )}
          </div>
