    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-12 print:gap-6">
                <div className="md:col-span-3 text-soft-gray space-y-4 leading-relaxed print:text-black print:space-y-2 print:text-sm">
                ...
                <div className="md:col-span-2 space-y-8 print:space-y-4">
                    <div>
                        <h3 className="text-lg font-poppins font-semibold text-white mb-3 print:text-black print:text-base print:mb-2">🧩 Core Values</h3>
                        <ul className="space-y-2 list-disc list-inside text-soft-gray print:text-black print:space-y-1 print:text-sm">
