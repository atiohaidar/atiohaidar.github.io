...
class TicketsProvider extends ChangeNotifier {
  ...
  List<Ticket> get openTickets => _tickets.where((t) => t.status == TicketStatus.open).toList();
  List<Ticket> get inProgressTickets => _tickets.where((t) => t.status == TicketStatus.inProgress).toList();
  List<Ticket> get solvedTickets => _tickets.where((t) => t.status == TicketStatus.solved).toList();
